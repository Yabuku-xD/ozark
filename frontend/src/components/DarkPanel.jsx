const steps = [
  ...
  ['Enforce', 'Block prompt injection, PII leakage, toxic output, dangerous code, and sensitive file access at runtime.'],
  ['Score', 'Collapse every run into a deployment confidence score with dimension-level evidence.'],
]
    ...
    <section className="engine-panel section" id="engine">
      <div className="container engine-grid">
        <div className="engine-copy reveal">
          ...
          <p>
            Ozark combines a policy engine, Markov behavior model, coverage analyzer, and live connector so evaluation happens against actual agent behavior instead of static examples.
          </p>
        </div>
