const lines = [
  ...
  ['14:02:11.420', 'eval/no-secrets', 'OK', 'regex_expectation_passed'],
  ['14:02:12.003', 'privacy/pii', 'BLOCK', 'pii_leak_via_tool_args'],
  ['14:02:12.884', 'issue/group', 'OPEN', 'critical_signature_seen_3x'],
    ...
    <section className="section terminal-section" id="terminal">
      <div className="container">
        <div className="section-header reveal">
          ...
          <p>Inspect the exact scenario, turn outcome, evaluator finding, issue grouping, guardrail hit, and final confidence impact without shipping traces to a hosted vendor.</p>
        </div>
